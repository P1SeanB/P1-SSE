// ═══ DEV placeholder TEMPLATE — committed, contains no real values ═══════════
//
...
// DIFFERS per environment: 'dev' here, 'prod' in the prod file.
param environmentName = 'dev'

// ── Shared PostgreSQL (consumed, never managed here) ────────────────────────
// DIFFERS per environment — dev and prod are separate servers.
//   az postgres flexible-server show -g LegaC-Estimator-Development `
//     -n legac-estimator-postgres-dev --query fullyQualifiedDomainName -o tsv
